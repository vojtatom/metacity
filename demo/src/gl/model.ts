...
module GLModels {
    ...
    export class StreetModel extends GLModel {
        data: GL.StreetModelInterface;
        program: GLProgram.StreetProgram;

        lineSegments: number;

        constructor(gl: WebGL2RenderingContext, programs: GL.GLProgramList, model: GL.StreetModelInterface){
            super(gl);
    ...
    export class TerrainModel extends GLModel {
        data: GL.TerrainModelInterface;
        program: GLProgram.TerrainProgram;

        triangles: number;

        constructor(gl: WebGL2RenderingContext, programs: GL.GLProgramList, model: GL.TerrainModelInterface){
            super(gl);
